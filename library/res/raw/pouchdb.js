...
function openDB() {
  if (typeof window !== 'undefined') {
    if (window.navigator && window.navigator.sqlitePlugin && window.navigator.sqlitePlugin.PouchDroid.SQLiteNativeDB.openNativeDatabase) {
      return navigator.sqlitePlugin.PouchDroid.SQLiteNativeDB.openNativeDatabase.apply(navigator.sqlitePlugin, arguments);
    } else if (window.sqlitePlugin && window.sqlitePlugin.PouchDroid.SQLiteNativeDB.openNativeDatabase) {
      return window.sqlitePlugin.PouchDroid.SQLiteNativeDB.openNativeDatabase.apply(window.sqlitePlugin, arguments);
    } else {
      return window.PouchDroid.SQLiteNativeDB.openNativeDatabase.apply(window, arguments);
    }
  }
}
...
webSqlPouch.valid = function () {
  if (typeof window !== 'undefined') {
    if (window.navigator && window.navigator.sqlitePlugin && window.navigator.sqlitePlugin.PouchDroid.SQLiteNativeDB.openNativeDatabase) {
      ...
      return true;
    } else if (window.PouchDroid.SQLiteNativeDB.openNativeDatabase) {
      return true;
    }
  }
  return false;
...
function ajax(options, callback) {
  ...
  if (process.browser && typeof PouchDroid.NativeXMLHttpRequest !== 'undefined') {
